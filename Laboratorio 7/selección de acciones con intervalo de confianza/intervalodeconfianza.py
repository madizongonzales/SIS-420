...
def run(episodes, is_training=True, render=False, epsilon=0.1, ucb_coefficient=2.0):
...
if __name__ == '__main__':
    run(15000, is_training=True, render=False, epsilon=0.1, ucb_coefficient=2.0)  # Primero entrena el modelo
    run(10, is_training=False, render=True, epsilon=0.1, ucb_coefficient=2.0)  # Luego usa el modelo entrenado con renderización
